...
class ArticleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      /*
      * یک روش برای در آوردن اپ بار طراحی :
      * میایم یک استایل برای تمام اپ بار های اپ در main تعریف میکنیم که سفید و بدون سایه است
      * به عنوان attr برای اسکافلد یک اپ بار تعریف میکنیم و text ها و آیکون ها را بهش میدیم
      *
      * */
      // appBar: AppBar(
      //   title: Text('Article'),
      ...
      floatingActionButton: Container(
        /* اگه width و height را خودمون دیم بهش خودش خیلی بدفرم میشه */
        width: 111,
        height: 48,
